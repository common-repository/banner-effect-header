...
Banner Effect header let you replace standard header image by dynamic HTML5 and Flash banners made with Banner Effect Software.
...
1. Choose a banner from the list.
2. Your website displays a dynamic HTML5 banner!
